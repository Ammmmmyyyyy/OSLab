...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	52c50513          	addi	a0,a0,1324 # 800560 <main+0x20>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	52c50513          	addi	a0,a0,1324 # 800580 <main+0x40>
...
exit(int error_code) {
  ...
  800126:	46650513          	addi	a0,a0,1126 # 800588 <main+0x48>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	42278793          	addi	a5,a5,1058 # 8005a0 <main+0x60>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	4e6a8a93          	addi	s5,s5,1254 # 8006bc <main+0x17c>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800404:	41878793          	addi	a5,a5,1048 # 800818 <error_string>
  ...
  800414:	1c060613          	addi	a2,a2,448 # 8005d0 <main+0x90>
  ...
  800428:	19c60613          	addi	a2,a2,412 # 8005c0 <main+0x80>
  ...
  80049c:	121a0a13          	addi	s4,s4,289 # 8005b9 <main+0x79>
  ...
  8004da:	0e250513          	addi	a0,a0,226 # 8005b8 <main+0x78>
  8004de:	046000ef          	jal	800524 <strnlen>
  8004e2:	40ac8cbb          	subw	s9,s9,a0
                p = "(null)";
  8004e6:	00000417          	auipc	s0,0x0
  8004ea:	0d240413          	addi	s0,s0,210 # 8005b8 <main+0x78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  8004ee:	00000a17          	auipc	s4,0x0
  8004f2:	0cba0a13          	addi	s4,s4,203 # 8005b9 <main+0x79>
...
main(void) {
  800540:	1141                	addi	sp,sp,-16
    ...
    panic("FAIL: T.T\n");
  800542:	00000617          	auipc	a2,0x0
  800546:	15660613          	addi	a2,a2,342 # 800698 <main+0x158>
  80054a:	45a9                	li	a1,10
  80054c:	00000517          	auipc	a0,0x0
  800550:	15c50513          	addi	a0,a0,348 # 8006a8 <main+0x168>
main(void) {
  800554:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  800556:	ad1ff0ef          	jal	800026 <__panic>
