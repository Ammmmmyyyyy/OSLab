...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5bc50513          	addi	a0,a0,1468 # 8005f0 <main+0xb0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	5bc50513          	addi	a0,a0,1468 # 800610 <main+0xd0>
...
exit(int error_code) {
  ...
  800126:	4f650513          	addi	a0,a0,1270 # 800618 <main+0xd8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	4b278793          	addi	a5,a5,1202 # 800630 <main+0xf0>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	616a8a93          	addi	s5,s5,1558 # 8007ec <main+0x2ac>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800404:	54878793          	addi	a5,a5,1352 # 800948 <error_string>
  ...
  800414:	25060613          	addi	a2,a2,592 # 800660 <main+0x120>
  ...
  800428:	22c60613          	addi	a2,a2,556 # 800650 <main+0x110>
  ...
  80049c:	1b1a0a13          	addi	s4,s4,433 # 800649 <main+0x109>
  ...
  8004da:	17250513          	addi	a0,a0,370 # 800648 <main+0x108>
  8004de:	046000ef          	jal	800524 <strnlen>
  8004e2:	40ac8cbb          	subw	s9,s9,a0
                p = "(null)";
  8004e6:	00000417          	auipc	s0,0x0
  8004ea:	16240413          	addi	s0,s0,354 # 800648 <main+0x108>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  8004ee:	00000a17          	auipc	s4,0x0
  8004f2:	15ba0a13          	addi	s4,s4,347 # 800649 <main+0x109>
...
int
main(void) {
  800540:	1141                	addi	sp,sp,-16
    cprintf("Making sure bss works right...\n");
  800542:	00000517          	auipc	a0,0x0
  800546:	1e650513          	addi	a0,a0,486 # 800728 <main+0x1e8>
main(void) {
  80054a:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  80054c:	b55ff0ef          	jal	8000a0 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800550:	00001597          	auipc	a1,0x1
  800554:	ab058593          	addi	a1,a1,-1360 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  800558:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  80055a:	4681                	li	a3,0
  80055c:	00100637          	lui	a2,0x100
  800560:	a029                	j	80056a <main+0x2a>
  800562:	2685                	addiw	a3,a3,1
  800564:	0791                	addi	a5,a5,4
  800566:	00c68f63          	beq	a3,a2,800584 <main+0x44>
        if (bigarray[i] != 0) {
  80056a:	4398                	lw	a4,0(a5)
  80056c:	db7d                	beqz	a4,800562 <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  80056e:	00000617          	auipc	a2,0x0
  800572:	1da60613          	addi	a2,a2,474 # 800748 <main+0x208>
  800576:	45b9                	li	a1,14
  800578:	00000517          	auipc	a0,0x0
  80057c:	1f050513          	addi	a0,a0,496 # 800768 <main+0x228>
  800580:	aa7ff0ef          	jal	800026 <__panic>
  800584:	00001717          	auipc	a4,0x1
  800588:	a7c70713          	addi	a4,a4,-1412 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80058c:	4781                	li	a5,0
  80058e:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  800592:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  800594:	2785                	addiw	a5,a5,1
  800596:	0711                	addi	a4,a4,4
  800598:	fed79de3          	bne	a5,a3,800592 <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80059c:	4681                	li	a3,0
  80059e:	00100737          	lui	a4,0x100
  8005a2:	a029                	j	8005ac <main+0x6c>
  8005a4:	2685                	addiw	a3,a3,1 # 100001 <_start-0x70001f>
  8005a6:	0591                	addi	a1,a1,4
  8005a8:	02e68063          	beq	a3,a4,8005c8 <main+0x88>
        if (bigarray[i] != i) {
  8005ac:	419c                	lw	a5,0(a1)
  8005ae:	fed78be3          	beq	a5,a3,8005a4 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005b2:	00000617          	auipc	a2,0x0
  8005b6:	1c660613          	addi	a2,a2,454 # 800778 <main+0x238>
  8005ba:	45d9                	li	a1,22
  8005bc:	00000517          	auipc	a0,0x0
  8005c0:	1ac50513          	addi	a0,a0,428 # 800768 <main+0x228>
  ...
  8005cc:	1d850513          	addi	a0,a0,472 # 8007a0 <main+0x260>
  8005d0:	ad1ff0ef          	jal	8000a0 <cprintf>
    cprintf("testbss may pass.\n");
  8005d4:	00000517          	auipc	a0,0x0
  8005d8:	20450513          	addi	a0,a0,516 # 8007d8 <main+0x298>
  8005dc:	ac5ff0ef          	jal	8000a0 <cprintf>
  ...
  8005e0:	4501                	li	a0,0
    bigarray[ARRAYSIZE + 1024] = 0;
  8005e2:	00402797          	auipc	a5,0x402
  8005e6:	a007af23          	sw	zero,-1506(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005ea:	b31ff0ef          	jal	80011a <exit>
